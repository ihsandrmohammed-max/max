...

{
    ...
    "data": [
        ...
        'views/base/multi_channel_sale_payment.xml',
        'views/base/salla_order_status.xml',
        'views/menus.xml',
        ...
        'views/core/stock_picking.xml',
        'views/feeds/category_feed.xml',
        'views/feeds/order_feed.xml',
        # 'views/feeds/order_feed_payment.xml',
        ...
        'wizard/salla_order_json_viewer.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'odoo_multi_channel_sale/static/src/components/json_tree_viewer/json_tree_viewer.xml',
            'odoo_multi_channel_sale/static/src/css/custom_ribbons.css',
            'odoo_multi_channel_sale/static/src/css/dashboard.css',
            'odoo_multi_channel_sale/static/src/css/json_tree_viewer.css',
            'odoo_multi_channel_sale/static/src/js/dashboard.js',
            'odoo_multi_channel_sale/static/src/js/json_tree_viewer.js',
            'odoo_multi_channel_sale/static/src/components/json_tree_viewer/json_tree_viewer.js',
        ],
        # 'web.assets_qweb': [
